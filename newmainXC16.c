...
void pinSelect(){
	...
	RPOR2bits.RP5R	= 9;	//RP5 output for SS1	for FLASH    
...
void ioSetup(){
	...
	TRISBbits.TRISB5	= 0;	//RB5 output for SS1
	TRISBbits.TRISB6    = 0;    //RB6 output for SS2                p42
	...
	//Debug
	TRISAbits.TRISA7 = 0; //Output debug led for record
}
